//core packages
var gulp = require("gulp-help")(require("gulp"), ["hideEmpty"]);
...
gulp.task(
  ...
  "checks for updates on RealFaviconGenerator",
  function(done) {
...
gulp.task(
  "serve:dist",
  "build src & start production server",
  ["build:dist"],
  function() {
...
gulp.task("build", "build src to dev", [
  "cphtml",
  "cpimg",
  "processSCSS",
  "cpjs",
...
gulp.task("build:dist", "build src to dist", [
  "cphtml:dist",
  "cpimg:dist",
  "processSCSS:dist",
  "cpjs:dist",
